namespace MegaZord.Library.Common
{
    ...
    /// </summary>
    public class MZValidationResult
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MZValidationResult"/> class.
        /// </summary>
        public MZValidationResult()
        {
        }
        ...
        public MZValidationResult(string memeberName, string message)
        {
        ...
        /// </summary>
        /// <param name="message">The message.</param>
        public MZValidationResult(string message)
        {
            Message = message;
        }
