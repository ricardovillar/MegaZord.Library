namespace MegaZord.Library.EF.ViewCache
{
    ...
    public abstract class MZViewCacheFactoryBase : DbMappingViewCacheFactory
    {
        ...
        public override DbMappingViewCache Create(string conceptualModelContainerName, string storeModelContainerName)
        {
            ...
            if (viewsXml != null)
            {
                ...
                {
                    return new MZMappingViewCache(viewsForMapping);
                }
            }
            ...
            return new MZMappingViewCache(hash, views);
        }

        // virtual for mocking
        internal virtual StorageMappingItemCollection GetMappingItemCollection()
        {
            return MZInteractiveViews.GetMappingItemCollection(this);
        }
                ...
                new XElement("mapping-views",
                    ...
                    views.Select(
                        viewDefinition =>
                            new XElement(
                                "view",
                                new XAttribute("extent", GetExtentFullName(viewDefinition.Key)),
