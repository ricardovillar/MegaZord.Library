namespace MegaZord.Library.EF.ViewCache
{
    ...
    /// </summary>
    public class MZFileViewCacheFactory : MZViewCacheFactoryBase
    {
        ...
        /// <summary>
        /// Creates an instance of the <see cref="MZFileViewCacheFactory"/> class.
        /// </summary>
        /// <param name="viewFilePath">A path to the file where the views are stored.</param>
        public MZFileViewCacheFactory(string viewFilePath)
        {
