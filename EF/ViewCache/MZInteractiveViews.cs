namespace MegaZord.Library.EF.ViewCache
{
    ...
    /// </summary>
    public static class MZInteractiveViews
    {
        private static object objToLock = new object();
        /// <summary>
        /// Teste if mapviewcache is empty
        /// </summary>
        public static bool CanAddMapViewCache(DbContext dbcontext)
        {
            ...
            return (storageMappingItemCollection.MappingViewCacheFactory == null) && (_mappingItemCollectionLookUp.Count == 0);
        }
        ...
        public static void SetViewCacheFactory(ObjectContext context, DbMappingViewCacheFactory viewCacheFactory)
        {
            ...
            lock (objToLock)
            {
                ...
                try
                {
                    ...
                    if (storageMappingItemCollection.MappingViewCacheFactory == null)
                        storageMappingItemCollection.MappingViewCacheFactory = viewCacheFactory;
                    if (_mappingItemCollectionLookUp.Count == 0)
